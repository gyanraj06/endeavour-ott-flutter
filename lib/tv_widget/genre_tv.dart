...
import 'package:endeavour/screens/tv_details_screen.dart';
...
class GenreTV extends StatefulWidget {
  ...
  @override
  State<GenreTV> createState() => _GenreTVState();
}

class _GenreTVState extends State<GenreTV> {
  @override
  Widget build(BuildContext context) {
    //movie retrieveing by selected genre, copy of get_genre
    return FutureBuilder<TVModel>(
      //get genre list of movie from api
      future: HttpRequest.getDiscoverTVShows(
          widget.genreId), //api keyword from api doc
